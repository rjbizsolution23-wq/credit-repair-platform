...
export class CreditBuildingOverviewComponent implements OnInit, OnDestroy {
  ...
  loadData(): void {
    ...
    combineLatest({
      strategies: this.creditBuildingService.getStrategies({ }, { page: 1, limit: 100 }),
      recommendations: this.creditBuildingService.getRecommendations({ }, { page: 1, limit: 100 }),
      goals: this.creditBuildingService.getGoals({ }, { page: 1, limit: 100 }),
      analytics: this.creditBuildingService.getAnalytics()
    })
    .pipe(
    ...
    .subscribe({
      next: ({ strategies: strategiesResponse, recommendations: recommendationsResponse, goals: goalsResponse, analytics }) => {
